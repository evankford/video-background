    ...
    initializeVideoAPI(source) {
        ...
        if (this.browserCanAutoPlay && id) {
            ...
            apiPromise.then((message) => {
                this.logger(message);
                this.player.ready = false;
                this.initializeVideoPlayer(source);
            }).catch((message) => {
