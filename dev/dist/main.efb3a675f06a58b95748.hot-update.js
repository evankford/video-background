...
class VideoBackground extends HTMLElement {
    ...
    constructor() {
        ...
        logger("Debugging video-background.");
        this.init();
    }
    init() {
        this.status = "waiting";
