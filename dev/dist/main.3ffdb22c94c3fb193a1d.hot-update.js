...
class VideoBackground extends HTMLElement {
    ...
    initializeVideoAPI() {
        ...
        if (this.browserCanAutoPlay && source && ('id' in source) && source.id) {
