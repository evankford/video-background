...
/* harmony import */ var can_autoplay__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! can-autoplay */ "./node_modules/.pnpm/can-autoplay@3.0.2/node_modules/can-autoplay/build/can-autoplay.es.js");
Object(function webpackMissingModule() { var e = new Error("Cannot find module './providers/vimeo'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
Object(function webpackMissingModule() { var e = new Error("Cannot find module './providers/youtube'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const videoSourceModules = {
    vimeo: {
        api: Object(function webpackMissingModule() { var e = new Error("Cannot find module './providers/vimeo'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
        player: Object(function webpackMissingModule() { var e = new Error("Cannot find module './providers/vimeo'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
    },
    youtube: {
        api: Object(function webpackMissingModule() { var e = new Error("Cannot find module './providers/youtube'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
        player: Object(function webpackMissingModule() { var e = new Error("Cannot find module './providers/youtube'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
    }
};
class VideoBackground extends HTMLElement {
    ...
    buildDOM() {
        this.buildOverlay();
        this.buildPoster();
        can_autoplay__WEBPACK_IMPORTED_MODULE_1__["default"].video({ timeout: 500, muted: true }).then(({ result, error }) => {
            if (result == false) {
