...
class VideoBackground extends HTMLElement {
    ...
    getSourcesFilteredBySize(sources) {
        ...
        if (!this.breakpoints) {
            logger('Breakpoints not defined at size filter. Something\'s wrong');
            return sources;
        }
